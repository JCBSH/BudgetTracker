 ...
 */
public class CategoryArrayAdaptor extends ArrayAdapter<String> {
    public CategoryArrayAdaptor(ArrayList<String> choices, Context context) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        icon.setImageResource
                (getContext().getResources().getIdentifier(Transaction.findCategoryIconResource(c),
