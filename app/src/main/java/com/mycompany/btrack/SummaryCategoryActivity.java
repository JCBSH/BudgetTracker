...
public class SummaryCategoryActivity extends ListActivity implements MonthPickerFragment.Callbacks{

    public static final String TAG = SummaryCategoryActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_summary_category);
        setTitle(getString(R.string.SummaryCategoryActivity_title));
        ...
        setDateButtonText();
        mCategory = Transaction.getCategoryChoices();
        CategoryAdapter adapter =  new CategoryAdapter(SummaryCategoryActivity.this, mCategory);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_summary_category, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_logout:
                ...
                Intent intent = new Intent(SummaryCategoryActivity.this, LoginActivity.class);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            iconImageView.setImageResource
                    (getResources().getIdentifier(
                            Transaction.findCategoryIconResource(c), null, getPackageName()));
            titleTextView.setText(c);
            double amount = Transaction.TotalSumOfListByCategory(mTransactions, c);
